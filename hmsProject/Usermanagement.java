...
public class Usermanagement extends javax.swing.JFrame {
    ...
    public void show_user() {
        hmsDB a = new hmsDB();
        ArrayList<dataUSER> list = a.userList();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        hmsDB s = new hmsDB();
        s.dbLoad();
        boolean Serach = s.serachID(UserID);
        if (UserID.isEmpty() || UserPW.isEmpty()) {
            JOptionPane.showMessageDialog(this, "아이디, 비밀번호를 확인 후 다시 시도해주세요.", "메세지", JOptionPane.INFORMATION_MESSAGE);
            
        } else if(Serach){
            JOptionPane.showMessageDialog(this, "중복되는 아이디가 있습니다. 다른 아이디를 입력해주세요.", "메세지", JOptionPane.INFORMATION_MESSAGE);
        } 
        else{
            s.update(UserID, UserPW, isAdmin);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        hmsDB c = new hmsDB();
        c.dbLoad();
        boolean Serach = c.serachID(UserID);
        if (Serach) {
            c.DeleteID(UserID);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        jTable1.setModel(new DefaultTableModel(null, new String[]{"UserID", "UserPW", "isAdmin"}));
        show_user();
