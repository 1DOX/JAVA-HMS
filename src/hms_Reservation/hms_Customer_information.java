 ...
 */
public class hms_Customer_information extends hmsDB_Reservation {

    /**
     * Creates new form hms_Customer_information
     */
    public hms_Customer_information() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String cardnum = jTextField4.getText();
        String roomnum = jTextField5.getText();

        String changename = jTextField1.getText();
        String member = jTextField8.getText();

        if (datachange(name, address, phonenum, cardnum, roomnum, changename, member) == false) {
            JOptionPane.showMessageDialog(this, "변경할 대상을 찾을 수 없습니다. 확인 후 다시 입력하세요.", "메세지", JOptionPane.INFORMATION_MESSAGE);
            dispose();
            new hms_Customer_information().setVisible(true);

        } else {
            JOptionPane.showMessageDialog(this, "고객정보 수정이 정상적으로 완료되었습니다.", "메세지", JOptionPane.INFORMATION_MESSAGE);
            dispose();
            new hms_Customer_information().setVisible(true);
        }
        dbClose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(hms_Customer_information.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
